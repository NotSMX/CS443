...
class Adam(Optimizer):
    ...
    def update_weights(self):
        ...
        self.wts -= (self.lr * vc)/(np.sqrt(pc) + self.eps)
...
class AdamW(Optimizer):
    ...
    def __init__(self, reg=None, lr=0.001, beta1=0.9, beta2=0.999, eps=1e-8, t=0):
        ...
        self.lr = lr
        self.reg = reg if reg is not None else 0.0
        self.beta1 = beta1
        self.beta2 = beta2
        self.eps = eps
        self.t = t
    ...
    def update_weights(self):
        ...
        # apply weight decay (regularization) after Adam update
        self.wts -= self.reg * self.wts
